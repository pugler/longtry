...
<div class="view-album-longtry-nav-area hidden-xs">
  <div class="container">
...
<!-- Add fancyBox -->
<link rel="stylesheet" href="<?php echo base_url();?>asset/fancybox/source/jquery.fancybox.css?v=2.1.5" type="text/css" media="screen" />
<script type="text/javascript" src="<?php echo base_url();?>asset/fancybox/source/jquery.fancybox.pack.js?v=2.1.5"></script>
<?php  /*
<script src="<?php echo base_url();?>asset/js/longtry_gallery.js"></script>
*/ ?>
